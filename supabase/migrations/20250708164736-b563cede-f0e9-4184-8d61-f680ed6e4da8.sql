...
-- Update existing leads table to add roofing-specific fields and fix status
ALTER TABLE leads 
...
-- First remove the default, then change the type, then add new default
ALTER TABLE leads ALTER COLUMN status DROP DEFAULT;
ALTER TABLE leads ALTER COLUMN status TYPE lead_status USING 'new'::lead_status;
