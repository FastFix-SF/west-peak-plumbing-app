...
CREATE POLICY IF NOT EXISTS "employees_see_assigned_projects"
ON public.projects
FOR SELECT
TO authenticated
USING (
...
CREATE POLICY IF NOT EXISTS "employees_insert_own_photos"
...
CREATE POLICY IF NOT EXISTS "employees_see_assigned_project_photos"
ON public.project_photos
FOR SELECT
TO authenticated
USING (
