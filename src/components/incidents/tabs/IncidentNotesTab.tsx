...
import { useIncidentNotes, useCreateIncidentNote, useDeleteIncidentNote } from '@/hooks/useIncidents';
...
export function IncidentNotesTab({ incidentId }: IncidentNotesTabProps) {
  ...
  const handleDeleteNote = async (noteId: string) => {
    try {
      await deleteNote.mutateAsync({ id: noteId, incidentId });
